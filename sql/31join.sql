USE w3schools;
DESC Orders;
SELECT o.OrderID, o.OrderDate, c.CustomerName, e.FirstName, e.LastName, s.ShipperID
FROM Orders o
         JOIN Customers c
...
VALUES (1, 'kim'),
       (2, 'lee'),
       (3, 'park');
INSERT INTO my_table52 (id, address)
VALUES (10, 'seoul'),
       (20, 'jeju'),
       (30, 'dokdo'),
       (40, 'busan');
INSERT INTO my_table53(id, c_id, a_id, email)
values (1, 1, 20, 'gmail'),
       (2, 2, 30, 'yahoo'),
       (3, 2, 40, 'duck'),
       (4, 3, 40, 'naver');
